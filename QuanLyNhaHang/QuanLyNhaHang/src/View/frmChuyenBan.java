 ...
 * @author admin
 */
public class frmChuyenBan extends javax.swing.JFrame {

    /**
     * Creates new form frmChuyenBan
     */
    frmDatBan frmdatban;
    public frmChuyenBan(frmDatBan frmdatban ) {
        initComponents();
     ...
     void loadCombox()
     {
         ...
         {
             cbFrom.addItem(item.getTenBan());
         }
         
         List<BanAn> listBanan = dal_BanAn.getBanAn_Change();
         for (BanAn item:listBanan)
         {
             cbTu.addItem(item.getTenBan());
         }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(cbTu, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String tenBan_TO= (String) cbTu.getSelectedItem();
        String tenBan_From=(String) cbFrom.getSelectedItem();
        dal_BanAn.getTrangThaiBan(tenBan_TO,tenBan_From);
         frmdatban.loadSoDoBanAn();
         this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmChuyenBan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmChuyenBan().setVisible(true);
            }
        });
    }
